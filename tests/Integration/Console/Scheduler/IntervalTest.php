...
{
    #[Test]
    public function interval_with_seconds_returns_correct_in_seconds(): void
    {
    ...
    #[Test]
    public function interval_with_minutes_returns_correct_in_seconds(): void
    {
    ...
    #[Test]
    public function interval_with_hours_returns_correct_in_seconds(): void
    {
    ...
    #[Test]
    public function interval_with_days_returns_correct_in_seconds(): void
    {
    ...
    #[Test]
    public function interval_with_weeks_returns_correct_in_seconds(): void
    {
    ...
    #[Test]
    public function interval_with_months_returns_correct_in_seconds(): void
    {
    ...
    #[Test]
    public function interval_with_years_returns_correct_in_seconds(): void
    {
