...
use Tempest\Commands\CommandBusDiscovery;
...
use Tempest\Events\EventBusDiscovery;
...
class KernelTest extends TestCase
{
    public function test_discovery_boot(): void
    {
        ...
        $this->assertSame(RouteDiscovery::class, $appConfig->discoveryClasses[4]);
        $this->assertSame(ViewComponentDiscovery::class, $appConfig->discoveryClasses[5]);
        $this->assertSame(CommandBusDiscovery::class, $appConfig->discoveryClasses[6]);
        $this->assertSame(EventBusDiscovery::class, $appConfig->discoveryClasses[7]);
        $this->assertSame(ScheduleDisovery::class, $appConfig->discoveryClasses[8]);
        $this->assertSame(ConsoleCommandDiscovery::class, $appConfig->discoveryClasses[9]);
