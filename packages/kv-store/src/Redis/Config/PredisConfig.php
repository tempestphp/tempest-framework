...
final class PredisConfig implements RedisConfig
{
    public function __construct(
        ...
        /**
         * Specifies the protocol used to communicate with the Redis instance.
         */
        ...
        /**
         * Less common predis client options.
         */
        public array $options = [],

        /**
         * Less common predis connection options.
         */
