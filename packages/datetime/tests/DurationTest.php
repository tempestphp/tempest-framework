...
final class DurationTest extends TestCase
{
    ...
    public function test_fractions_of_second(): void
    {
        ...
        $this->assertSame([0, 0, 0, 42_000], Duration::microseconds(42)->getParts());
        $this->assertSame([0, 0, 1, 42_000], Duration::microseconds(1_000_042)->getParts());
        $this->assertSame([0, 0, 0, 42_000_000], Duration::milliseconds(42)->getParts());
        $this->assertSame([0, 0, 1, 42_000_000], Duration::milliseconds(1042)->getParts());
    }
