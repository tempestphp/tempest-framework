...
namespace Tempest\Container\Tests\Unit;
...
use Tempest\Container\Tests\Unit\Fixtures\BuiltinArrayClass;
use Tempest\Container\Tests\Unit\Fixtures\BuiltinDependencyArrayInitializer;
use Tempest\Container\Tests\Unit\Fixtures\BuiltinDependencyBoolInitializer;
use Tempest\Container\Tests\Unit\Fixtures\BuiltinDependencyStringInitializer;
use Tempest\Container\Tests\Unit\Fixtures\BuiltinTypesWithDefaultsClass;
use Tempest\Container\Tests\Unit\Fixtures\CallContainerObjectE;
use Tempest\Container\Tests\Unit\Fixtures\CircularWithInitializerA;
use Tempest\Container\Tests\Unit\Fixtures\CircularWithInitializerBInitializer;
use Tempest\Container\Tests\Unit\Fixtures\ClassWithLazySlowDependency;
use Tempest\Container\Tests\Unit\Fixtures\ClassWithLazySlowPropertyDependency;
use Tempest\Container\Tests\Unit\Fixtures\ClassWithSingletonAttribute;
use Tempest\Container\Tests\Unit\Fixtures\ClassWithSlowDependency;
use Tempest\Container\Tests\Unit\Fixtures\ContainerObjectA;
use Tempest\Container\Tests\Unit\Fixtures\ContainerObjectB;
use Tempest\Container\Tests\Unit\Fixtures\ContainerObjectC;
use Tempest\Container\Tests\Unit\Fixtures\ContainerObjectD;
use Tempest\Container\Tests\Unit\Fixtures\ContainerObjectDInitializer;
use Tempest\Container\Tests\Unit\Fixtures\ContainerObjectE;
use Tempest\Container\Tests\Unit\Fixtures\ContainerObjectEInitializer;
use Tempest\Container\Tests\Unit\Fixtures\DependencyWithBuiltinDependencies;
use Tempest\Container\Tests\Unit\Fixtures\DependencyWithTaggedDependency;
use Tempest\Container\Tests\Unit\Fixtures\HasTagObject;
use Tempest\Container\Tests\Unit\Fixtures\ImplementsInterfaceA;
use Tempest\Container\Tests\Unit\Fixtures\InjectA;
use Tempest\Container\Tests\Unit\Fixtures\InjectB;
use Tempest\Container\Tests\Unit\Fixtures\InterfaceA;
use Tempest\Container\Tests\Unit\Fixtures\IntersectionInitializer;
use Tempest\Container\Tests\Unit\Fixtures\InvokableClass;
use Tempest\Container\Tests\Unit\Fixtures\InvokableClassWithDependencies;
use Tempest\Container\Tests\Unit\Fixtures\InvokableClassWithParameters;
use Tempest\Container\Tests\Unit\Fixtures\OptionalTypesClass;
use Tempest\Container\Tests\Unit\Fixtures\SingletonClass;
use Tempest\Container\Tests\Unit\Fixtures\SingletonInitializer;
use Tempest\Container\Tests\Unit\Fixtures\SlowDependency;
use Tempest\Container\Tests\Unit\Fixtures\TaggedDependency;
use Tempest\Container\Tests\Unit\Fixtures\TaggedDependencyCliInitializer;
use Tempest\Container\Tests\Unit\Fixtures\TaggedDependencyWebInitializer;
use Tempest\Container\Tests\Unit\Fixtures\UnionImplementation;
use Tempest\Container\Tests\Unit\Fixtures\UnionInitializer;
use Tempest\Container\Tests\Unit\Fixtures\UnionInterfaceA;
use Tempest\Container\Tests\Unit\Fixtures\UnionInterfaceB;
use Tempest\Container\Tests\Unit\Fixtures\UnionTypesClass;
...
final class ContainerTest extends TestCase
{
        ...
        try {
            ...
            $this->assertStringContainsStringIgnoringLineEndings(
                <<<'TXT'
                	...
                	└── Tempest\Container\Tests\Unit\Fixtures\TaggedDependency
                TXT,
    ...
    public function test_call_function_with_parameters(): void
    {
        ...
        $this->assertEquals('My resolved class is Tempest\Container\Tests\Unit\Fixtures\SingletonClass', $result);
    }
