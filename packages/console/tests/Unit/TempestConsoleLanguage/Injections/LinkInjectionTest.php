...
namespace Tempest\Console\Tests\Unit\TempestConsoleLanguage\Injections;
...
final class LinkInjectionTest extends TestCase
{
    ...
    #[TestWith(['<href="https://tempestphp.com">Tempest</href>', "\e]8;;https://tempestphp.com\e\Tempest\e]8;;\e\\"])]
    #[TestWith([
        '<href="http://example.com/path?param=value!@#$%^&*()_+-={}:<>?,./">My link</href>',
        "\e]8;;http://example.com/path?param=value!@#$%^&*()_+-={}:<>?,./\e\My link\e]8;;\e\\",
    ])]
